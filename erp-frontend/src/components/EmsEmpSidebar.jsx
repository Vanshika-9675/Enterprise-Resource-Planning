...
const EmsEmpSidebar = ({ showMenu }) => {
  ...
  return (
    <div
      className={`transition-all duration-1000 ease-in-out z-50 bg-white dark:bg-[#02042B] dark:text-white sm:relative sm:flex sm:flex-col gap-2 sm:gap-16 rounded-br-xl h-screen min-h-[600px] py-6 absolute top-0 sm:left-0 ${
    ...
    >
      ...
      >
        ...
        <div
          className={`h-10 w-10 rounded-full bg-white dark:bg-[#02042B] absolute top-0 sm:flex justify-center items-center cursor-pointer hidden ${
