...
const EmsEmpNav = ({toggleMenu}) => {
  ...
  return (
    <div className='w-full'>
        <div className="pt-5 pl-8 pr-7 py-5 bg-white dark:bg-[#02042B] flex justify-between">
    <div className="hidden sm:flex max-w-2xl justify-between w-full">
      <div className="flex flex-col">
        <span className="text-base md:text-xl text-[#212B36] dark:text-white font-semibold">
          Hello Employee!
        </span>
      ...
      <div className="lg:max-w-sm w-2/5 lg:w-full border focus-within:border-blue-600 rounded-lg border-[#E7E7E7] py-3 px-4 justify-between items-center max-h-12 hidden md:flex">
        <input
          type="text"
          className="outline-none w-9/12 dark:bg-[#02042B] dark:text-white"
          placeholder="Search..."
        />
    ...
    <div
      className="cursor-pointer sm:hidden border border-[#E7E7E7] hover:border-blue-600 rounded-md flex justify-center items-center"
